                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="d-sm-flex justify-content-between">
                            <a href="{{ route('admin.categories.create') }}" class="btn-sm btn-success text-white">Add Category</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="card-body">
                                ...
                                <table class="table header-border table-responsive-sm">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="font-weight-bold text-dark">Main Category</th>
                                    ...
                                    <tbody>
                                        @forelse ($productCategories as $key=> $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="" href="{{ route('admin.categories.edit', $category->id) }}">
                                                        <i class="fa fa-edit text-warning btn"></i>
                                                    </a>
                                                    <a class="" href="{{ route('admin.categories.destroy', $category->id) }}"
