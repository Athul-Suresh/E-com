...
<body
    ...
    <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%"
        ...
        <tr style="width:100%">
            <td>
                <table style="margin-top:32px" align="center" border="0" cellPadding="0" cellSpacing="0"
                ...
                <p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">Your confirmation link is
                    below - click it and we&#x27;ll help you to reset your password.</p>
                <table
                    style="background:rgb(245, 244, 245);border-radius:4px;margin-right:50px;margin-bottom:30px;padding:43px 23px"
                    align="center" border="0" cellPadding="0" cellSpacing="0" role="presentation" width="100%">
                    <tbody>
                        <tr>
                            <td>
                                <p
                                    style="font-size:15px;line-height:24px;margin:16px 0;text-align:center;vertical-align:middle">

                                    <a href="{{ $data['resetLink'] }}" target="_blank" rel="noopener noreferrer" style="background: crimson;padding:8px 15px;border-radius:2px;color:white;text-decoration:none">
                                       Verify
                                    </a>
                                </p>
                            </td>
                ...
                <p style="font-size:14px;line-height:24px;margin:16px 0;color:#000">If you didn&#x27;t request this
                    email, there&#x27;s nothing to worry about - you can safely ignore it.</p>
            </td>
        </tr>
    </table>
</body>
